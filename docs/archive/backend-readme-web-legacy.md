> Archived document: this file describes the retired Next.js web client and is kept only for historical reference.
> Current architecture is Expo mobile app + API-only backend under `backend/app/api/*`.
