...
import type { CleanDataRequest, CleanDataResponse } from "@analytics/contracts"
...
export async function POST(request: Request) {
  try {
    ...
    const { csvData } = (await request.json()) as CleanDataRequest
    ...
    const payload: CleanDataResponse = {
      success: true,
      data: parsed.entries,
